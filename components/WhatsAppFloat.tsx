export default function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed z-50 flex items-center justify-center rounded-full bg-wa shadow-lg transition-transform duration-300 hover:scale-110"
      style={{
        bottom: 'calc(1.5rem + env(safe-area-inset-bottom, 0px))',
        right: '1.5rem',
        width: 58,
        height: 58,
        boxShadow: '0 4px 22px rgba(37,211,102,.5)',
      }}
    >
